...
!function (d) {
    ...
    a.prototype.respChart = function (r, t, e, o) {
        ...
        var a = [], r = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"];
        if (0 < d("#line-chart-example").length) {
            var t = {
                labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
                datasets: [{
                    label: "Current Week",
                    backgroundColor: hexToRGB((e = (l = d("#line-chart-example").data("colors")) ? l.split(",") : r.concat())[0], .3),
                    borderColor: e[0],
            ...
            a.push(this.respChart(d("#line-chart-example"), "Line", t, {
        ...
        if (0 < d("#bar-chart-example").length) {
            var e = (l = d("#bar-chart-example").data("colors")) ? l.split(",") : r.concat(),
                o = document.getElementById("bar-chart-example").getContext("2d").createLinearGradient(0, 500, 0, 150);
            ...
            a.push(this.respChart(d("#bar-chart-example"), "Bar", n, {
                maintainAspectRatio: !1,
                legend: {display: !1},
                scales: {
                    yAxes: [{
        ...
        if (0 < d("#donut-chart-example").length) {
            ...
            a.push(this.respChart(d("#donut-chart-example"), "Doughnut", s, {
                maintainAspectRatio: !1,
                cutoutPercentage: 60,
                legend: {display: !1}
            }))
        ...
        if (0 < d("#radar-chart-example").length) {
            var l, i = {
                ...
                datasets: [{
                    label: "Desktops",
                    backgroundColor: hexToRGB((e = (l = d("#radar-chart-example").data("colors")) ? l.split(",") : r.concat())[0], .2),
                    borderColor: e[0],
                    ...
                    label: "Tablets",
                    backgroundColor: hexToRGB(e[1], .2),
                    borderColor: e[1],
